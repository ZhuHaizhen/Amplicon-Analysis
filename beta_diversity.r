...
p1 <- ggplot(points.w,aes(x = x,y = y, color = cave, shape = sample_type)) + theme_bw() + geom_point(alpha = 0.8, size = 3) + labs(x=paste("PCoA 1 (", format(100 * eig.w[1] / sum(eig.w), digits=4), "%)", sep=""), y=paste("PCoA 2 (", format(100 * eig.w[2] / sum(eig.w), digits=4), "%)", sep=""),title = "PCoA plot of weighted unifrac distance")
...
p2 <- ggplot(points.u,aes(x = x,y = y, color = cave, shape = sample_type)) + theme_bw() + geom_point(alpha = 0.8, size = 3) + labs(x=paste("PCoA 1 (", format(100 * eig.u[1] / sum(eig.u), digits=4), "%)", sep=""), y=paste("PCoA 2 (", format(100 * eig.u[2] / sum(eig.u), digits=4), "%)", sep=""),title = "PCoA plot of unweighted unifrac distance")
...
p3 <- ggplot(points.b,aes(x = x,y = y, color = cave, shape = sample_type)) + theme_bw() + geom_point(alpha = 0.8, size = 3) + labs(x=paste("PCoA 1 (", format(100 * eig.b[1] / sum(eig.b), digits=4), "%)", sep=""), y=paste("PCoA 2 (", format(100 * eig.b[2] / sum(eig.b), digits=4), "%)", sep=""),title = "PCoA plot of bray curtis distance")
